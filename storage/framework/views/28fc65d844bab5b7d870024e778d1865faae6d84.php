                        ...
                        <div class="col-md-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><?php echo e(('Login Pegawai')); ?></h1>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="<?php echo e(route('register')); ?>"><?php echo e(('Belum punya akun?')); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('user.auth.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project_website\github\clone\aplikasi_pegawai\resources\views/user/auth/login.blade.php ENDPATH**/ ?>
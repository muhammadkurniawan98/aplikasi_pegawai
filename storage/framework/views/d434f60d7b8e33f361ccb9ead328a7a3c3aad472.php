            ...
            <div class="card o-hidden border-0 shadow-none">
                ...
                <div class="card-body">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                        <?php if( $i = 1 + (($usulanKenaikanGaji->currentPage()>=1?$usulanKenaikanGaji->currentPage():1) - 1) * $usulanKenaikanGaji->perPage()): ?>
                            <?php $__currentLoopData = $usulanKenaikanGaji; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-center font-weight-light">
                                        <a class="btn btn-danger btn-icon-split btn-sm" href="<?php echo e(route('admin.gaji.show', $u->id)); ?>">
                    ...
                    <?php echo e($usulanKenaikanGaji->links('pagination::bootstrap-4')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project_website\github\clone\aplikasi_pegawai\resources\views/admin/verifikasi-usulan/index/kenaikan-gaji.blade.php ENDPATH**/ ?>
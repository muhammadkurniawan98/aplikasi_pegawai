...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="jabatan" name="jabatan" class="form-control" onselect="">
                        ...
                        <div class="form-group row">
                            <label for="golongan" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Golongan')); ?></label>

                            <div class="col-md-6">
                                <select id="golongan" name="golongan" class="form-control" onselect="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="pangkat" name="pangkat" class="form-control" onselect="">
                        ...
                        <div class="form-group row">
                            <label for="status_kepegawaian" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Status Kepegawaian')); ?></label>

                            <div class="col-md-6">
                                <select id="status_kepegawaian" name="status_kepegawaian" class="form-control" onselect="">
                        ...
                        <div class="form-group row">
                            <label for="status_tunjangan" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Status Tunjangan')); ?></label>

                            <div class="col-md-6">
                                <select id="status_tunjangan" name="status_tunjangan" class="form-control" onselect="">
...
unset($__errorArgs, $__bag); ?>" name="nip" value="<?php echo e(old('nip')); ?>" autofocus>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project_website\aplikasi_pegawai\resources\views/auth/register.blade.php ENDPATH**/ ?>
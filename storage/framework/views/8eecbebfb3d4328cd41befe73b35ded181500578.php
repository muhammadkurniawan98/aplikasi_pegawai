                            ...
                            <div class="col-md-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><?php echo e(('Register Admin')); ?></h1>
                                    </div>

                                    <form class="user" action="<?php echo e(route('admin.register')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo e(route('admin.login')); ?>"><?php echo e(('Sudah punya akun?')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('user.auth.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project_website\github\clone\aplikasi_pegawai\resources\views/admin/auth/register.blade.php ENDPATH**/ ?>
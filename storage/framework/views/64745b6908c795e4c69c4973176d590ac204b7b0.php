                        ...
                        <div class="row">
                            <div class="col-md">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <?php if($usulanPensiun != null): ?>
                                            <?php if($usulanPensiun->status_verifikasi == 0): ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <td class="text-center font-weight-light">
                                                    <a href="<?php echo e(route('download.pensiun.sk', $usulanPensiun->skUsulanPegawai->file_sk_usulan_pensiun)); ?>" class="btn btn-success btn-icon-split btn-sm">
                                                    <span class="icon text-white-12">
                                                        <i class="fas fa-file-download"></i>
                                                    </span>
                                                        <span class="text">Unduh File</span>
...
<?php echo $__env->make('user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project_website\github\clone\aplikasi_pegawai\resources\views/user/usulan/index/pensiun.blade.php ENDPATH**/ ?>
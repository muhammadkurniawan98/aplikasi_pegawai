                        ...
                        <div class="row">
                            <div class="col-md">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        @if($usulanPensiun != null)
                                            @if($usulanPensiun->status_verifikasi == 0)
                                            ...
                                            @else
                                                ...
                                                <td class="text-center font-weight-light">
                                                    <a href="{{ route('download.pensiun.sk', $usulanPensiun->skUsulanPegawai->file_sk_usulan_pensiun) }}" class="btn btn-success btn-icon-split btn-sm">
                                                    <span class="icon text-white-12">
                                                        <i class="fas fa-file-download"></i>
                                                    </span>
                                                        <span class="text">Unduh File</span>

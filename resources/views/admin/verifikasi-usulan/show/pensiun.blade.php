                            ...
                            <div class="col-md-6">
                                <div class="card o-hidden border-0 shadow-none">
                                    <div class="card-header d-flex justify-content-center">
                                        <img src="{{ asset(profile_picture($usulanPensiun->nip)) }}" width="79%">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card o-hidden border-0 shadow-none">
                                    ...
                                    <div class="card-body">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->nama }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">Jabatan</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->jabatan }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">Pangkat</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->pangkat }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">Golongan</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->golongan }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">Status Kepegawaian</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->status_kepegawaian }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">Status Tunjangan</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->status_tunjangan }}</dd>

                                            <dd class="col-sm-5 font-weight-normal">NIP</dd>
                                            <dd class="col-sm-7 font-weight-light">{{ $usulanPensiun->nip }}</dd>
                                        </dl>
                                        <a href="{{ route('admin.pensiun.download', $usulanPensiun->nip) }}"

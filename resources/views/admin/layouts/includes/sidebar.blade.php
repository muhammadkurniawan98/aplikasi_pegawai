<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item @yield('admin-dashboard')">
    ...
    <li class="nav-item @yield('admin-gaji')">
        <a class="nav-link" href="{{ route('admin.gaji.index') }}">
            <i class="fas fa-clipboard-check"></i>
            <span>KENAIKAN GAJI</span>
        </a>
    </li>
    <li class="nav-item @yield('admin-pangkat')">
        <a class="nav-link" href="{{ route('admin.pangkat.index') }}">
            <i class="fas fa-clipboard-check"></i>
            <span>KENAIKAN PANGKAT</span>
        </a>
    </li>
    <li class="nav-item @yield('admin-pensiun')">
        <a class="nav-link" href="{{ route('admin.pensiun.index') }}">
            <i class="fas fa-clipboard-check"></i>
            <span>PENSIUN</span>
        </a>
    </li>
    ...
    <li class="nav-item @yield('admin-rekapitulasi')">
